...
- (void)getSignDateWithYear:(NSString *)year andMonth:(NSString *)month {
    ...
    [YLYKSigninServiceModule getSigninCalendar:parameters success:^(id responseObject){
...
- (void)setupCalendarViewWithSignDates {
    ...
    self.calendarView = [[YLYKFyCalendarView alloc] initWithFrame:CGRectMake(10, 30, SCREEN_WIDTH - 20, SCREEN_WIDTH - 20 + 50)];
    //日期状态
