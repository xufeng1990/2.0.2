        ...
        return (
            <TouchableOpacity style={styles.tab} onPress={() => { this._gotopage() }}>
                <View style={styles.tabItem}>
                    <Text
                        style={{ color: this.state.activeTab ? "#0fabfa" : "#5a5a5a", fontSize: 18 * g_AppValue.precent }}>
                        {this.props.tabNames[this.props.pageID]}
                    </Text>
                </View>
                <View
                    style={{ backgroundColor: this.state.activeTab ? "#0fabfa" : "#ffffff", width: 85 * g_AppValue.precent, height: 1 * g_AppValue.precent, marginTop: 10 * g_AppValue.precent }}>
                </View>
            </TouchableOpacity>
        );
    }
