...
// 类
export default class FansAndFocus extends Component {
    _fansData = [];
    _followee = [];
    ...
    componentDidMount() {
        ...
        //粉丝页面数据
      YLYKServices.$fans.getFansList({'page': 1,'user_id': this.props.user_id + ''})
        .then((data) => {
            this._fansData = [];
    ...
    _renderRow(rowData, sectionID, rowID) {
        ...
        return (
            ...
            <TouchableOpacity activeOpacity={1} onPress={() => {this._goToInformationPage(fansId, is_followee, rowID)}}>
