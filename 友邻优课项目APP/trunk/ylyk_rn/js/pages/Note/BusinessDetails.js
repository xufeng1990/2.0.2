...
var AlertModule = YLYKNatives.$dialog;
    ...
    renderHeader() {
        ...
        return (
            <StudentDetailHeader
                ...
                learningTimeText='学习时长/分钟' fansNumber={focusData.stat.fans_count}
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, backgroundColor: '#f2f5f6' }}>
                ...
                {this.props.hideHeader == 1 ? Platform.OS == 'ios' ? null
                    : <NavigationView
                        navigator={this.props.navigator}
                    ...
                    : <NavigationView
                        ...
                        leftItemTitle={Icon.back}
                        leftItemFunc={this._goBack.bind(this)}
                        ightItemFunc={() => this._goToPlayerView()}
                        rightImageSource={this.state.isExistPlayedTrace == 1 ? this.state.isPlayingOrPause == 0 ? require('../../imgs/play1.png') : require('../../imgs/play.gif') : null} />
                }
