...
import static com.reactmodules.consts.ModuleName.YLYK_ADDRESS_SERVICE_MODULE;
...
public class YLYKAddressServiceModule extends ReactContextBaseJavaModule {


    private YLBaseService service;

    public YLYKAddressServiceModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public String getName() {
        return YLYK_ADDRESS_SERVICE_MODULE;
    }
