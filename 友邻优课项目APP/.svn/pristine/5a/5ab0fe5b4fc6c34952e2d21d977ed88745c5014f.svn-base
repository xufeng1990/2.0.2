...
import static com.reactmodules.consts.ModuleName.YLYK_ALBUM_SERVICE_MODULE;
...
public class YLYKAlbumServiceModule extends ReactContextBaseJavaModule {


    private YLBaseService service;

    public YLYKAlbumServiceModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public String getName() {
        return YLYK_ALBUM_SERVICE_MODULE;
    }
