...
import static com.reactmodules.consts.ModuleName.YLYK_TEACHER_SERVICE_MODULE;
...
public class YLYKTeacherServiceModule extends ReactContextBaseJavaModule {


    private YLBaseService service;

    public YLYKTeacherServiceModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    public String getName() {
        return YLYK_TEACHER_SERVICE_MODULE;
    }
