package com.reactmodules.oauth;
...
import static com.reactmodules.consts.ModuleName.YLYK_TOKEN_SERVICE_MODULE;
...
public class YLYKTokenServiceModule extends ReactContextBaseJavaModule {


    public YLYKTokenServiceModule(ReactApplicationContext reactContext) {
        super(reactContext);
    }

    @Override
    public String getName() {
        return YLYK_TOKEN_SERVICE_MODULE;
    }
