...
//pages
import VideoPlayer from './ViewPlayer.js';
//组件
...
export default class VideoView extends Component {
    ...
    // 加载完成
    componentDidMount() {
      this.changeLandscape = DeviceEventEmitter.addListener('changeLandscape',(str)=>{
        if (str === 'landscape') {
          YLYKNatives.$screen.landscapAction();
        }else if(str === 'portraitAction') {
    ...
    componentWillUnmount() {
        ...
        this.changeLandscape && this.changeLandscape.remove();
    }
