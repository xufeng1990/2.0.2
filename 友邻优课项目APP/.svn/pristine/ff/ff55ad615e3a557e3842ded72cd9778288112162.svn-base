...
import com.reactmodules.loadingview.YLLoadingReactPackage;
...
public class YLNoteActivity extends Activity implements DefaultHardwareBackBtnHandler {
    ...
    private static final String YLNEW_AUDIO_ACTIVITY = "com.zhuomogroup.ylyk.activity.YLAudioActivity";
...
//                .addPackage(new ExtraDimensionsPackage())
                .addPackage(new YLLoadingReactPackage(this))
    ...
    public void openAudio(YLYKPlayerNativeModule.IntentActivity intentActivity) {
        Class toActivity;
        try {
