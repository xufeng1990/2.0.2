...
import static com.reactmodules.consts.ModuleName.YLYK_SERVICE_MODULE;
...
public class YLYKServiceModule extends ReactContextBaseJavaModule {



    public YLYKServiceModule(ReactApplicationContext reactContext) {
        super(reactContext);
    }

    @Override
    public String getName() {
        return YLYK_SERVICE_MODULE;
    }
