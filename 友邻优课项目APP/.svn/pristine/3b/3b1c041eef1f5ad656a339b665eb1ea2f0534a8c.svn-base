 ...
 */
public class YLPhotoAdapter extends RecyclerView.Adapter<YLPhotoAdapter.PhotoViewHolder> {
    ...
    public YLPhotoAdapter(Context mContext, ArrayList<String> photoPaths) {
